...
* The results are poor. I wanted to specifically train on a small geographic area and chose Redding, CA because it gets wildfires and I can also get tabular weather data from NOAA.
...
* The EDA directory has dirty and clean Bradley, CA csv files. The EDA notebook I wrote got deleted so I will need to re-write it.